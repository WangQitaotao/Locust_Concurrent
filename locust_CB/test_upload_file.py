...
if __name__ == '__main__':
    import os
    # os.system("locust -f test_upload_file_ab.py --headless -u 3 -r 1 -t 4s --skip-log-setup")
    os.system("locust -f test_upload_file.py --headless -u 1 -r 1 -t 5s --skip-log-setup --only-summary --csv=../report/upload_file/result --html=../report/upload_file/report.html")
